...
: ${DATASET_DIR:="/data/s4954475/DeepLearningExamples/PyTorch/SpeechSynthesis/FastPitch/prosody-control/"}
: ${BATCH_SIZE:=32}
: ${FILELIST:="phrases/stimuli_no_tags.tsv"}
: ${AMP:=false}
: ${TORCHSCRIPT:=true}
: ${WARMUP:=0}
: ${REPEATS:=1}
...
: ${FASTPITCH="/scratch/s4954475/FastPitch_notags_checkpoint/FastPitch_notags_checkpoint_400.pt"}
...
if [ ! -n "$OUTPUT_DIR" ]; then
    OUTPUT_DIR="./output/stimuli_$(basename ${FILELIST} .tsv)"

...
: ${OUTPUT_DIR:="/scratch/s4954475/FastPitch_output_4th_try/"}
: ${LOG_FILE:=$OUTPUT_DIR/nvlog.json}
: ${DATASET_PATH:=prosody-control}
: ${TRAIN_FILELIST:=filelists/pc_audio_pitch_text_train.txt}
: ${VAL_FILELIST:=filelists/pc_audio_pitch_text_val.txt}
: ${AMP:=false}
: ${SEED:=""}
